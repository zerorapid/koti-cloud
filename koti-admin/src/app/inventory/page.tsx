      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
           ...
           <button 
             ...
             className="flex items-center gap-2 px-5 py-2.5 bg-primary text-white rounded-lg font-black text-[11px] uppercase tracking-widest shadow-md hover:opacity-90 active:scale-95 transition-all"
           >
