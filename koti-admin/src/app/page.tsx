        ...
        <div className="bg-card p-10 rounded-xl shadow-sm border border-border animate-in slide-in-from-bottom-4 duration-700">
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="space-y-2">
              <label className="text-[10px] font-black text-muted-foreground uppercase tracking-widest ml-1">Administrator ID</label>
            ...
            <div className="flex items-center justify-between px-1">
              ...
              <button type="button" className="text-[11px] font-bold text-primary hover:underline">Reset Access</button>
            </div>
