...
const SYSTEM_MODULES = [
  { id: "orders", label: "Order Management", description: "Manage live Kanban throughput and deliveries.", href: "/orders", icon: ShoppingBag, color: "bg-blue-500", status: "ONLINE" },
  ...
  { id: "users", label: "Customer Management", description: "Manage 8,400+ users and loyalty tiers.", href: "/users", icon: Users, color: "bg-purple-500", status: "ONLINE" },
         ...
         <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <div className="grid grid-cols-2 gap-4 w-full lg:w-auto">
               <div className="bg-white/10 backdrop-blur-md p-6 rounded-lg border border-white/10 text-center">
                  ...
                  <p className="text-2xl font-black text-white tracking-tight">₹2.4M</p>
               </div>
               <div className="bg-white/10 backdrop-blur-md p-6 rounded-lg border border-white/10 text-center">
                  <p className="text-[9px] font-black text-white/60 uppercase tracking-widest mb-1">Active Carts</p>
                  <p className="text-2xl font-black text-white tracking-tight">1,284</p>
               </div>
            </div>
         </div>
      </div>
