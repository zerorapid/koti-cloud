...
const INITIAL_TIERS = [
  { id: "gold", name: "Gold", discount: 25, threshold: 500, color: "text-amber-500", bg: "bg-amber-50", icon: Crown, benefits: ["Priority Support", "Exclusive Gold Deals"] },
  { id: "platinum", name: "Platinum", discount: 30, threshold: 1000, color: "text-slate-500", bg: "bg-slate-50", icon: Star, benefits: ["Free Returns", "Early Access to Sales", "10% Extra Cashback"] },
  { id: "diamond", name: "Diamond", discount: 35, threshold: 2000, color: "text-violet-500", bg: "bg-violet-50", icon: Zap, benefits: ["Free Delivery Always", "No Platform Fee", "VIP Assistant"] }
];
...
export default function LoyaltyPage() {
  ...
  const handleUpdateTier = (updatedTier: any) => {
    ...
    setEditingTier(null);
    showToast(`${updatedTier.name} tier updated successfully!`);
  };
  ...
  const handleGlobalSync = () => {
    ...
    setTimeout(() => {
      setIsSaving(false);
      showToast("All tiers synchronized with user-facing app.");
    }, 1200);
  };
